...
const Schwarmverhinderung = (props) => {
    ...
    const methodTyp = [
        { label: "Zellen brechen", value: "Zellen brechen" },
        { label: "Kunstschwarm/Schwarmvorwegnahme", value: "Kunstschwarm/Schwarmvorwegnahme" },
        { label: "Schwarm abgegangen", value: "Schwarm abgegangen" },
    ...
    const handleDate = (e) => {
        ...
        temp.schwarmverhinderung[0].date = date;
    }
    ...
    const handleMethode = (e) => {
        ...
        temp.schwarmverhinderung[0].methode = e.value;
        setDataForUpdate(temp);
    }

    const handleAndere = (e) => {
        setAndere(e.target.value);
        temp.schwarmverhinderung[0].andere = andere;
    }
    ...
    const deleteData = (e) => {
        e.preventDefault();
        console.log(id);
        dispatch(deleteMassNahmenData(props.data._id,id, "schwarmverhinderung"))
            .then(() => {
                handleShowDeleteOff();
            })
            .catch((err) => {
        ...
        <div class="container" style={{ paddingTop: "20px" }}>
            <div class="py-5">
                <div class="container">
                    <div class="row hidden-md-up justify-content-center">
                        {
                            props.data ? <>
                                {props.data.data["schwarmverhinderung"].map(function (data, index) {
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Enter schwarmverhinderung details</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
...
export default Schwarmverhinderung;